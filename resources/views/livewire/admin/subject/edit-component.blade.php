<div>
    ...
    @endif
    {{ Form::model($subject, ['route' => ['admin.subject.update', $subject->id],'files' => true,'method' => 'PUT']) }}

    <div class="mb-1 row">
        {{ Form::label('curriculam_id', 'Curriculam', ['class' => 'col-sm-3 col-form-label']) }}
        <div class="col-sm-7">
            {{ Form::select('curriculam_id', $curriculams, old('curriculam_id'), ['wire:model' => 'curriculam','class' => 'form-control','placeholder' => 'Pick a curriculam']) }}
    ...
    <div class="mb-1 row">
        ...
        <div class="col-sm-7">
            {{ Form::select('grade_id', $grades, old('grade_id'), ['wire:model' => 'grade','class' => 'form-control','placeholder' => 'Pick a Grade']) }}
