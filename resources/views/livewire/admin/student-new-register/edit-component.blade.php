<div>
    ...
    @endif
    <form wire:submit.prevent="storeStudent({{$student_id}})" class="checkbox_section">
        <div class="row tin">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="form-label" for="validationCustom01">Lead Status</label>
                    <select class="form-control" wire:model="status" wire:click="updateStatus({{$student_id}})" >
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="tin">
                        ...
                        <input type="text" class="form-control" wire:model="preferable_time"
                               placeholder="Enter Preferable Call Back Time">
                    </div>
                </div>
            </div>
        </fieldset>
        <fieldset class="border mt-2 p-1">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="tin">
                        <p>Email Address</p>
                        <input type="text" class="form-control" wire:model="guardian_email"
        ...
        <fieldset class="border mt-2 p-1">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="tin">
                        <p>Curriculum</p>
                        <input type="text" class="form-control" wire:model="school_curriculum"
                ...
                <div class="col-md-12">
                    <div class="tin">
                        <p>Course</p>
                        <input type="text" class="form-control" wire:model="school_course"
        ...
        <fieldset class="border mt-2 p-1">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tin">
                        <p>Address (Line 1)</p>
                        <input type="text" class="form-control" wire:model="addressLine1"
                ...
                <div class="col-md-12">
                    <div class="tin">
                        <p>Address (Line 2)</p>
                        <input type="text" class="form-control" wire:model="addressLine2"
