    ...
    <form wire:submit.prevent="storeTeacher">
                    ...
                    <table class="table table-sm table-bordered">
                        ...
                        @foreach($days as $key => $day)
                            ...
                            <tr>
                                ...
                                <td>{{ $day }}</td>
                                <td>
                                    <input class="form-control form-control-sm" type="time" value="{{ old('active_status',$teacher->availability[$key]['to_time']) }}" name="availability[][{{$key}}][to_time]"></td>
                                <td><input class="form-control form-control-sm" type="time" value="{{ old('active_status',$teacher->availability[$key]['from_time']) }}" name="availability[][{{$key}}][from_time]"></td>
                            </tr>
                        @endforeach
        ...
        <fieldset class="border p-1">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <img src="{{ asset('s3/30/30/' . $image) }}">
                    <input class="form-control" type="file" wire:model="update_image" placeholder="Upload Photo">
                </div>
                <div class="col-md-12">
        ...
        <fieldset class="border mt-2 p-1">
            ...
            <div class="teacher_teaching">
                ...
                <button type="button" wire:click="addRowTeacherEducations()" class="btn btn-primary">Add Row</button>
            </div>
        </fieldset>
        <fieldset class="border mt-2 p-1">
            ...
            <div class="teacher_teaching">
                ...
                <button type="button" wire:click="addRowTeacherSkill()" class="btn btn-primary">Add Row</button>
            </div>
        </fieldset>
