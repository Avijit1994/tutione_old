        ...
        @if ($question_type == 'mcq')
            ...
            @if ($option_type == 'image')
                <div class="mb-1 row">
                    ...
                    <div class="col-sm-7">
                        {{-- <img src="{{ $option_image['option_1']->temporaryUrl() }}"> --}}
                    <img id="preview-image-before-upload" src="{{ $option_image['option_1'] ? asset('storage/' . $option_image['option_1']) : 'https://via.placeholder.com/100' }}"
