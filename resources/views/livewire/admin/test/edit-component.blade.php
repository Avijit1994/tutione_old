<div>
    <form wire:submit.prevent>
        ...
        <div class="mb-1 row">
            ...
            <div class="col-sm-7">
                <div wire:ignore>
                    {{ Form::textarea('description', old('description', $description), ['wire:model.lazy' => 'description', 'class' => 'form-control', 'placeholder' => 'Description']) }}
                </div>
        ...
        <div class="mb-1 row">
            <div class="col-sm-7 offset-3">
                <button type="submit" wire:click="save" class="btn btn-info">Submit</button>
