            ...
            <div class="row">
                <div class="d-flex justify-content-between flex-column col-xl-4 col-21">
                    <div class="d-flex justify-content-start">
                        <span class="b-avatar badge-light-danger rounded" style="width: 104px; height: 104px;">
                            <span class="b-avatar-img">
                                <img
                                    src="{{ empty($teacher->image) ? $teacher->getUrlfriendlyAvatar(100) : asset('s3/100/100/'.$teacher->image) }}"
                                    alt="avatar">
                            </span>
                        </span>
                        <div class="d-flex flex-column ml-1">
                            <div class="mb-1">
                                ...
                                <span class="card-text">{{ $teacher->email }}</span>
                            </div>
                            <div class="d-flex flex-wrap">
                                <a
                                    href="{{ route('admin.teacher-new-join.edit',$teacher) }}"
                    ...
                    <div class="d-flex align-items-center">
                        <select class="form-control" wire:model="status" wire:click="updateStatus({{$teacher}})">
                ...
                <div class="col-xl-4 col-12">
                    <table class="mt-2 mt-xl-0 w-100">
                        <tr>
                            <th class="pb-50"><span class="font-weight-bold">Curriculum Name</span></th>
                            <td class="pb-50">
                                {{ $teacher->teacherSkill->implode('curriculam.name',',') }}
                            </td>
                        </tr>
                        <tr>
                            <th class="pb-50"><span class="font-weight-bold">Grade</span></th>
                            <td class="pb-50 text-capitalize">
                                {{ $teacher->teacherSkill->implode('grade.name',',') }}
                            </td>
                        </tr>
                        <tr>
                            <th class="pb-50"><span class="font-weight-bold">Subject</span></th>
                            <td class="pb-50 text-capitalize">
                                {{ $teacher->teacherSkill->implode('subject.name',',') }}
                            </td>
                        </tr>
                        <tr>
                            <th class="pb-50"><span class="font-weight-bold">Register Date</span></th>
                            <td class="pb-50">
                                {{ $teacher->created_at }}
                            </td>
                        </tr>
                        <tr>
                            <th><span class="font-weight-bold">Contact</span></th>
                            <td>
                                {{ $teacher->phone }}
                            </td>
                        </tr>
                ...
                <div class="col-xl-4 col-12">
                    <table class="mt-2 mt-xl-0 w-100">
                        <tr>
                            <th class="pb-50"><span class="font-weight-bold">Experience</span></th>
                            <td class="pb-50">
                                {{ $teacher->experience }}
                            </td>
                        </tr>
                        <tr>
                            <th class="pb-50"><span class="font-weight-bold">Device Use</span></th>
                            <td class="pb-50 text-capitalize">
                                {{ $teacher->device_use }}
                            </td>
                        </tr>
                        <tr>
                            <th class="pb-50"><span class="font-weight-bold">Internet Use</span></th>
                            <td class="pb-50 text-capitalize">
                                {{ $teacher->internet_use }}
                            </td>
                        </tr>
                        <tr>
                            <th class="pb-50"><span class="font-weight-bold">Profile Headline</span></th>
                            <td class="pb-50">
