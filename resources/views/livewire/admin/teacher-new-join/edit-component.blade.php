<div class="d-flex flex-row align-items-end">
    ...
    <form wire:submit.prevent="storeTeacher">
        ...
        <fieldset class="border mt-2 p-1">
            ...
            <div class="teacher_teaching">
                    ...
                    @foreach ($teacherEducations as $key => $entry)
                        <div class="col-md-11 row teacher-search-row mb-4">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                {{--                                <a href="{{ Storage::disk('s3')->url($entry['documents']) }}" target="_blank">View</a>--}}
                ...
                <button type="button" wire:click="addRowTeacherEducations()" class="btn btn-primary">Add Row
                </button>
            </div>
        </fieldset>
        <fieldset class="border mt-2 p-1">
    ...
    <form action="{{ route('admin.teacher-new-join.destroy', $teacher->id) }}" method="POST">
        @csrf
        @method('DELETE')
    </form>
</div>
