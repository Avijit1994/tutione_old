...
<footer class="footer footer-static footer-light">
    <p class="clearfix mb-0">
            <span class="float-md-start d-block d-md-inline-block mt-25">&copy; 2022 TheTuitionE Technology LLC All Rights Reserved | Powered By
                <a class="ms-25" href="https://idearre.com/" target="_blank">Idearre Technology</a>
            </span>
    </p>
</footer>
