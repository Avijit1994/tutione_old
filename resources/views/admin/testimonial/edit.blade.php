    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            ...
            <div class="card-tools float-right">
                <a href="{{ route('admin.testimonial.index') }}" class="btn btn-sm btn-primary">Back</a>
            </div>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            @endif
            {{ Form::model($testimonial,['route' => ['admin.testimonial.update',$testimonial->id], 'files' => true,'method' => 'PUT']) }}
            <div class="mb-1 row">
