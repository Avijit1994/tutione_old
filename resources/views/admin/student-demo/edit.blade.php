<x-admin-layout>
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title">curriculam Edit</h3>
            <div class="card-tools float-right">
                <a href="{{ route('admin.curriculam.index') }}" class="btn btn-sm btn-primary">Back</a>
            </div>
        </div>
        <div class="card-body">
            @if ($errors->any())
            ...
            @endif
            {{ Form::model($curriculam, ['route' => ['admin.curriculam.update', $curriculam->id], 'files' => true, 'method' => 'PUT']) }}
            <div class="mb-1 row">
            ...
            <div class="mb-1 row">
                ...
                <div class="col-sm-7">
                    <img id="preview-image-before-upload" src="{{ $curriculam->image ? asset('images/100/100/' . $curriculam->image) : 'https://via.placeholder.com/100' }}"
