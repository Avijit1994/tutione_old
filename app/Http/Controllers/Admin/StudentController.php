...
class StudentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.student.index', compact('students'), $this->data);
    }
    ...
    public function newRegister(Request $request)
    {
        ...
        return view('admin.student.new-register', compact('students'), $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.student.create', compact('student'), $this->data);
    }
    ...
    public function store(StoreStudentRequest $request)
    {
        ...
        return redirect()->route('admin.student.index')->with('success', 'Create Successful');
    }
    ...
    public function show(Student $student)
    {
        ...
        return view('admin.student.show', compact('student'), $this->data);
    }
    ...
    public function edit(Student $student)
    {
        ...
        return view('admin.student.edit', compact('student'), $this->data);
    }
     ...
     * @return Application|Factory|View
     */
    public function editNewRegister(Student $student)
    {
        $this->setPageTitle('Student', 'List of all student');
    ...
    public function update(UpdateStudentRequest $request, Student $student)
    {
        ...
        return redirect()->route('admin.student.index')->with('success', 'Update Success');
    }
    ...
    public function destroy(Student $student)
    {
        ...
        return redirect()->route('admin.student.index')->with('success', 'Delete Success');
    }
}
